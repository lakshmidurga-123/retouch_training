...
public class SortEmployeesExample {
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "Lakshmi", 65000));
        employees.add(new Employee(2, "Priya", 45000));
        employees.add(new Employee(3, "Jaya", 80000));
        employees.add(new Employee(4, "Rishi", 55000));
